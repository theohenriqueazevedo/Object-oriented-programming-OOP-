...
class CtrlTurma:       
    ...
    def salvaTurmas(self):
        # Salva a lista de turmas no arquivo
    ...
    def criaTurma(self, event):
        ...
        self.salvaTurmas()  # Salva a lista de turmas após criar uma nova
    ...
    def mostraTurmas(self):
        ...
        for turma in self.listaTurmas:
            str += f"Código: {turma.codigo}\n"
            str += f"Disciplina: {turma.disciplina.codigo}\n"
            str += "Estudantes:\n"
            for estud in turma.estudantes:
                str += f"{estud.nroMatric} - {estud.nome}\n"
            str += "------\n"
